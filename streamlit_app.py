...
st.write(
    "아래 장소에서 궁금한건 뭐든지 물어보세요. (예: 내일 여업시간, 등산화, 피자가 먹고싶어, 상품권 등)"
...
hyundai_pangyo = """
    ...
    편의시설:(장소명,층,전화번호,세부내역)
        ...
        유모차데스크,지하1층 or 5층,031-5170-3290,36개월 이하의 유아를 동반한 고객님들께 청결하게 관리된 유모차를 대여
        ...
        의류수선실,4층 or 6층,4층(031-5170-2421~3) 6층(031-5170-2600~1),의류 수선실은 원하시는 상품으로 리폼, 수선, 재단 등을 실시
